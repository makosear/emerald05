...
static const struct WindowTemplate sWindowTemplates[] =
{
    ...
    // TODO: Refactor new SwSh info panel(s)
    // [WIN_DISPLAY_INFO] = {
    //     .bg = 1,
    //     .tilemapLeft = 0,
    //     .tilemapTop = 11,
...
{
    {1, 2, 3},      // Standard menus
    {4, 2, 5},      // Info basic (grey BG)
};
...
static void InitSupplementalTilemaps(void)
{
    // NOTE: Disabled party menu & close button prompts
...
static void CreatePartyMonsSprites(bool8 visible)
{
    ...
    // NOTE: Party sprites are now always visible
    // if (!visible)
    // {
    //     for (i = 0; i < count; i++)
    //     {
...
static u8 HandleInput_OnButtons(void)
{
    ...
    do
    {
        ...
        if (JOY_NEW(A_BUTTON))
            return (cursorPosition == 0) ? INPUT_NONE : INPUT_CLOSE_BOX;
