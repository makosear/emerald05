...
#define P_EVOLUTION_LEVEL_1_LEARN   GEN_6  // Since Gen 8, Pokémon evolving while at level 1 do not get the chance to learn their level 1 moves, while before they did.
